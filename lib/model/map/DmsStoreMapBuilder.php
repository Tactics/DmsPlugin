...
/**
 * This class adds structure of 'dms_store' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 */
class DmsStoreMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'plugins.ttDmsPlugin.lib.model.map.DmsStoreMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('dms_store');
		$tMap->setPhpName('DmsStore');
