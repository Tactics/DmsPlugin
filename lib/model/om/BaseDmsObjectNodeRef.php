...
/**
 * Base class that represents a row from the 'dms_object_node_ref' table.
 *
 * 
 *
...
abstract class BaseDmsObjectNodeRef extends BaseObject  implements Persistent {
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of DmsObjectNodeRef (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     DmsObjectNodeRef Clone of current object.
	 * @throws     PropelException
	 */
