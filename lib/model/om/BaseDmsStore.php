...
/**
 * Base class that represents a row from the 'dms_store' table.
 *
 * 
 *
...
abstract class BaseDmsStore extends BaseObject  implements Persistent {
	...
	/**
	 * Collection to store aggregation of collDmsNodes.
	 * @var        array
	 */
	protected $collDmsNodes;

	/**
	 * The criteria used to select the current contents of collDmsNodes.
	 * @var        Criteria
	 */
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of DmsStore (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     DmsStore Clone of current object.
	 * @throws     PropelException
	 */
	...
	/**
	 * Temporary storage of collDmsNodes to save a possible db hit in
	 ...
	 * Otherwise if this DmsStore has previously
	 * been saved, it will retrieve related DmsNodes from storage.
	 * If this DmsStore is new, it will return
	...
	/**
	 * Returns the number of related DmsNodes.
	 *
	 * @param      Criteria $criteria
	 ...
	 * If this collection has already been initialized with
	 * an identical criteria, it returns the collection.
	 * Otherwise if this DmsStore is new, it will return
	 * an empty collection; or if this DmsStore has previously
	 * been saved, it will retrieve related DmsNodes from storage.
	 *
