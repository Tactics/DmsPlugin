...
/**
 * Base class that represents a row from the 'dms_node_aspect' table.
 *
 * 
 *
...
abstract class BaseDmsNodeAspect extends BaseObject  implements Persistent {
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of DmsNodeAspect (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     DmsNodeAspect Clone of current object.
	 * @throws     PropelException
	 */
